...
function Main() {
  ...
  const fetchData = async () => {
      //   buraya const {data} da diyebiliriz
    const response = await axios.get(`${REACT_APP_API_BASE_URL}/user`, {
            //   burada headers olarak girmemizin sebebi çünkü bu api nin sahibi olan site headers olarak yazmamımız istemiş. başka site de params olarak istemişti
